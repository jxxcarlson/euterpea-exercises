...
s =  instrument player bass :=: instrument player tenor 
        :=: instrument player tenor2 :=: instrument player solo


-- chorale :: Int -> Music Pitch
-- chorale n =
--     instrument ChurchOrgan (take n bass) 
--       :=: instrument ChurchOrgan (take n tenor)
--       :=: instrument ChurchOrgan (take n tenor2)
--       :=: instrument Flute (take n solo)
